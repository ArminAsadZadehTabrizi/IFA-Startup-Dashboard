  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: "assistant",
      content:
        "Hallo! Ich bin dein Impact Factory Startup-Assistent. Frag mich gerne etwas über die Startups, ihre Projekte, SDGs oder andere Details.",
      timestamp: new Date(),
    },
  ])
  ...
  const handleSendMessage = async () => {
    ...
    if (!canSendMessage()) {
      const errorMessage: ChatMessage = {
        ...
        role: "assistant",
        content: `Du hast dein Tageslimit von ${dailyLimit} Fragen erreicht. Das Limit wird um Mitternacht zurückgesetzt. 🕛`,
        timestamp: new Date(),
      }
            ...
            {remainingQuestions <= 5 && remainingQuestions > 0 && (
              <Alert className="bg-yellow-50 border-yellow-200">
                ...
                <AlertDescription className="text-sm text-yellow-800">
                  Noch {remainingQuestions} von {dailyLimit} Fragen heute übrig.
                </AlertDescription>
              </Alert>
            )}
            ...
            {isLimitReached && (
              <Alert className="bg-red-50 border-red-200">
                ...
                <AlertDescription className="text-sm text-red-800">
                  Tageslimit erreicht. Reset um Mitternacht. 🕛
                </AlertDescription>
              </Alert>
            )}
